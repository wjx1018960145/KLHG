...
export default {
  ...
  requestAllProToken(params){
    return axios.post(`${base}${partner}/selectProWithtoken`, params).then(res=>res)
  },
  requestAllCity(params){
    return axios.post(`${base}${utils}/all`, params).then(res=>res)
  },
  requestAddCity(params){
    return axios.post(`${base}${utils}/add`, params).then(res=>res)
  },
